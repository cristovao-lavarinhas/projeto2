...
public class SplashController {
    ...
    public void initialize() {
        // Carregar o logotipo
        Image logo = new Image(getClass().getResource("/com/example/projetojavafx/icons/logotipo.png").toExternalForm());
    ...
    private void openRoleSelection() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/projetojavafx/RoleSelection.fxml"));
